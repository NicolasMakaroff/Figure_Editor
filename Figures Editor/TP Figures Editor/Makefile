...
$(SRC)/figures/OldPolygon.java \
$(SRC)/figures/NGon.java \
$(SRC)/figures/OldNGon.java \
$(SRC)/figures/Star.java \
...
$(SRC)/figures/listeners/creation/StarCreationListener.java \
...
$(SRC)/images/MagicDraw.png \
$(SRC)/images/MagicDraw_small.png \
