...
/**
 * Listener (incomplet) des évènements souris pour agir sur les figures.
...
public abstract class AbstractFigureListener
    implements MouseListener, MouseMotionListener, MouseWheelListener, Signature
{
	/**
	 * Le drawing model à modifier par ce listener. Celui ci contient
	 ...
	 * point de départ et le point terminal pour éliminer les figures de taille
	 * 0;
	 */
	                                 ...
	                                 int nbSteps)
	{
		...
		if (drawingModel == null)
		{
			System.err.println(getClassName() + "::" + getMethodName()
			    + " caution : null drawing model");
		}

		if (history == null)
		{
			System.err.println(getClassName() + "::" + getMethodName()
			    + " caution : null history manager");
		}

		if (tipLabel == null)
		{
			System.err.println(getClassName() + "::" + getMethodName()
			    + " caution : null tip label");
		}
	}
	 ...
	 * réaliser.
	 * @param e l'évènement souris à utiliser pour initier la création la
	 * sélection ou la transformation d'une nouvelle figure à la position de cet
	 * évènement
	 */
	 ...
	 * dans un {@link MouseListener#mouseClicked(MouseEvent)} suivant la figure
	 * à créer.
	 * @param e l'évènement souris à utiliser lors de la terminaison d'une
	 * action sur une figure
	 */
