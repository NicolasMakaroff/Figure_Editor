...
public class InfoPanel extends JPanel
{
	 ...
	 */
	private JLabel lblFigureName = new JLabel("None");

	/**
	 * Le label contenant l'icône correspondant à la figure
	 */
	private JLabel lblTypeicon = new JLabel("None");
	 ...
	 */
	private JLabel lblFillcolor = new JLabel("None");

	/**
	 * Le label contenant l'icône de la couleur du contour
	 */
	private JLabel lblEdgecolor = new JLabel("None");
	 ...
	 */
	private JLabel lblStroketype = new JLabel("None");
