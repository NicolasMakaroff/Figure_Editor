 ...
 */
public class JLabeledComboBox extends JPanel implements Signature
{
	/**
	 * Serializable class must have a serial version UID
	 */
	private static final long serialVersionUID = 6142914680355486667L;
	 ...
	 */
	public JLabeledComboBox(String title,
	                        String[] captions,
	                        int selectedIndex,
	...
	/**
	 * Mise en place de l'index de l'élément sélectioné dans le combobox
	 * @param anIndex le nouvel index de l'élément sélectionné
	 */
	public void setSelectedIndex(int anIndex)
	{
		if ((anIndex >= 0) && (anIndex < combobox.getItemCount()))
		{
	    ...
	    implements ListCellRenderer<IconItem>
	{
		 ...
		 * Serializable class must have a serial version UID
		 */
		private static final long serialVersionUID = -1604825335803195263L;
		...
		@Override
		public Component
		    getListCellRendererComponent(JList<? extends IconItem> list,
		                                 IconItem value,
		                                 int index,
		                                 boolean isSelected,
