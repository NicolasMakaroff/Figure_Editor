...
public class RoundRectangle extends Figure implements Signature {
	 ...
	 * @param fill
	 */
	public RoundRectangle(BasicStroke stroke, Paint edge, Paint fill,Point2D topLeft, Point2D bottomRight,double archeight,double arcwidth) {
		...
		shape = new RoundRectangle2D.Double(x, y, w, h,archeight,arcwidth);
	}
