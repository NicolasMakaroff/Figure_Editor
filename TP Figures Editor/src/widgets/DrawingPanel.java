...
public class DrawingPanel extends JPanel
    implements Observer, MouseListener, MouseMotionListener, Signature
{
	/**
	 * Serializable class must have a serial version UID
	 */
	private static final long serialVersionUID = -2354917805687388906L;
	...
	protected void paintComponent(Graphics g)
	{
		...
		if (drawingModel != null)
		{
			...
			{
				drawingModel.stream()
				    .forEach((Figure f) -> f.drawSelection(g2D));
			}
		}
		else
		{
	 ...
	 * @param data les données (evt) transmises par l'observable [non utilisé
	 * ici]
	...
	{
		sendInfoState = true;
		// TODO Rafraichissement du coordLabel avec les coordonnées du point de e
		// TODO Rafraichissement de l'InfoPanel avec les coordonnées du point de e
	}
	...
	public void mouseExited(MouseEvent e)
	{
		...
		sendInfoState = false;
		// TODO Rafraichissement du coordLabel avec les coordonnées du point de e
		// TODO Remise à zero de l'InfoPanel
	}
	...
	{
		/*
		 * TODO Rafraichissement du coordLabel avec les coordonnées du point p
		 * Uniquement si sendInfoState est vrai (sinon defaultCoordString)
		 * coordFormat est utilisé pour formater x et y
		 * Format : "x: XXX y: YYY" où XXX et YYY sont les coordonnées de p
		 */
	}
	...
	{
		/*
		 * TODO Rafraichissement de infoPanel avec la figure située sous le
		 * curseur de la souris (s'il y en a une) ou bien remise à zero de
		 * infoPanel s'il n'y a pas de figure sous le curseur
		 * Uniquement si sendInfoState est vrai
		 */
	}
}
