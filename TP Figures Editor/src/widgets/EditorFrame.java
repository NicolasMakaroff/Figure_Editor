...
public class EditorFrame extends JFrame implements Signature
{
		...
		public void itemStateChanged(ItemEvent e)
		{
			...
			if ((index >= 0) && (index < colors.length))
			{
				if (e.getStateChange() == ItemEvent.SELECTED)
				{
					...
					{
						/*
						 * TODO Utiliser PaintFactory.getPaint(combo, ...)
						 * pour obtenir une boite de diaglogue permettant
						 * de choisir la couleur dans une palette
						 */

						/*
						 * TODO Si chosenColor est valide alors la copier
						 * dans #paint sinon remettre le combo au
						 * lastSelectedIndex (paint inchangé)
						 */
					}
					else // regular color
					{
						// TODO copier la coulors de index dans #paint
					}
				...
				else if (e.getStateChange() == ItemEvent.DESELECTED)
				{
					...
					{
						/*
						 * TODO stocker la couleur de cet index dans #lastColor
						 * et l'index dans #lastSelectedIndex car ils seront
						 * utilisés plus tard
						 */
					}
				}
	...
	private class EdgeTypeListener implements ItemListener
	{
		...
		public void itemStateChanged(ItemEvent e)
		{
			...
			if (e.getStateChange() == ItemEvent.SELECTED)
			{
				...
				/*
				 * TODO Obtenir le LineType à partir de l'index,
				 * puis mettre en place ce EdgeType dans le drawingModel
				 */
			}
		}
	}
	...
	private class EdgeWidthListener implements ChangeListener
	{
		...
		public void stateChanged(ChangeEvent e)
		{
			...
			/*
			 * TODO obtenir le nombre du spinnerModel puis mettre en place
			 * ce edgeWidth dans le drawingModel
			 */
		}
	}
}
